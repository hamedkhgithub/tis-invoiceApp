...
>
      ...
      <ProductTable filteredData={filteredData} sortConfig={sortConfig} handleSort={handleSort} editingId={editingId} editFormData={editFormData} handleEditClick={(i) => { setEditingId(i.id); setEditFormData({...i}); }} handleInputChange={(e, f) => setEditFormData({ ...editFormData, [f]: f === 'quantity' ? parseInt(e.target.value) || 0 : e.target.value })} handleSave={handleSave} currency={currency} dollarRate={dollarRate} visibleColumns={visibleColumns} search={search} appMode={appMode} />
